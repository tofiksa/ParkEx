      ...
      <div className="w-full max-w-4xl rounded-2xl border border-border/60 bg-card/70 p-8 shadow-2xl backdrop-blur">
        ...
        <form action={createGarage} className="grid gap-4">
          ...
          <p className="text-xs text-muted-foreground">
            Tips: Kall `POST /api/storage/garage-upload-url` med filnavn for signed upload, legg deretter
            inn resulterende path/URL her. Budfrist er 30 dager hvis ikke satt.
          </p>
          <button
            type="submit"
