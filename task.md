...
| TASK-004 | Domain schema                                            | Migrations for users (roles), garages, bids, bid session with default 30d; storage buckets for images.| Medium-High| in_progress |
...
| TASK-007 | Buyer flows                                              | Browse listings, listing detail, join bidding; buyer profile showing active participations.           | Medium     | pending |
