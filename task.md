...
| TASK-006 | Seller listing flow                                      | Create garage listing (size, address/location, images, price, bid end with default 30d), storage via signed URLs. | High       | done        |
...
| TASK-012 | Mobile-first UX                                          | Responsive/mobile-first layouts with clear CTAs; accessibility pass.                                  | Medium     | done        |
| TASK-013 | Testing & CI                                             | Unit tests domain, integration/API, smoke for analytics/metrics; CI pipeline green.                   | Medium     | done        |
